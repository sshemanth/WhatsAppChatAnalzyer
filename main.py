...
st.markdown(
    "This app is designed to extract insights from WhatsApp chat data. It analyzes message count, user activity, word frequency, sentiment, and media sharing patterns. Users can understand communication dynamics, identify trends, and gain insights into the content of their WhatsApp conversations.")
